...
import AllResults from "./pages/dashboard/AllResults";
          ...
          <Routes>
            {isLoggedIn !== "true" ? (
              ...
              <Route element={<Layout />}>
                ...
                <Route path="/dashboard/result/:surveyid/:resultid" element={<Result />} />
                <Route
                  path="/dashboard/section/:surveyId/:sectionId/:subsectionId"
                  element={<SectionDetail />}
                />
                <Route path="/dashboard/survey/:id" element={<SurveyDetail />} />
                <Route path="/dashboard/results/:id" element={<AllResults />} />
