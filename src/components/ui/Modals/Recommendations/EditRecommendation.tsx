...
import { editRecommendation } from "../../../../helpers/recommendations";
...
const EditRecommendation: React.FC<Props> = ({
  surveyId,
  sectionId,
  setIsOpen,
  recommendation,
}) => {
  const [option2, setOption2] = useState<string>(recommendation?.from25to50);
  const [option3, setOption3] = useState<string>(recommendation?.from50to75);
  const [option4, setOption4] = useState<string>(recommendation?.from75to100);
